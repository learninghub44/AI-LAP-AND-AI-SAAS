...
const STRINGS: Record<NativeLocale, Strings> = {
  en: {
    tooltip: 'Cotell AI — local LLM router',
    runningOn: 'Running on {addr}',
    openDashboard: 'Open Dashboard',
    quitApp: 'Quit Cotell AI',
    running: 'running',
  ...
  'zh-CN': {
    tooltip: 'Cotell AI — 本地 LLM 路由器',
    runningOn: '运行于 {addr}',
    openDashboard: '打开仪表板',
    quitApp: '退出 Cotell AI',
    running: '运行中',
    requestsToday: '今日请求',
  ...
  fr: {
    tooltip: 'Cotell AI — routeur LLM local',
    runningOn: 'En cours sur {addr}',
    openDashboard: 'Ouvrir le tableau de bord',
    quitApp: 'Quitter Cotell AI',
    running: 'en cours',
  ...
  es: {
    tooltip: 'Cotell AI — enrutador LLM local',
    runningOn: 'En ejecución en {addr}',
    openDashboard: 'Abrir el panel',
    quitApp: 'Salir de Cotell AI',
  ...
  'pt-BR': {
    tooltip: 'Cotell AI — roteador LLM local',
    runningOn: 'Em execução em {addr}',
    openDashboard: 'Abrir o painel',
    quitApp: 'Sair do Cotell AI',
    running: 'em execução',
